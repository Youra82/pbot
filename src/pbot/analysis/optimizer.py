...
def objective(trial):
    ...
    risk_params = {
        ...
        # --- VERSCHÄRFTER CAP: Maximal 1.5% Risiko für Sicherheit ---
        'risk_per_trade_pct': trial.suggest_float('risk_per_trade_pct', 0.5, 1.5),
        # --------------------------------------------------------------
        
        # --- LEVERAGE CAP: Maximal 15x für Krypto-Futures ---
    ...
    # Verschärfte Kriterien für robustere Strategien
    if drawdown > 0.30 or trades < 15 or pnl < 5:  # Min 5% PnL, Max 30% DD, Min 15 Trades
        raise optuna.exceptions.TrialPruned()
    
    # Stabilitäts-Check: Win-Rate muss über 40% sein
